      ...
      <div className='divProyects'>
        <div className='divInfo'>
          ...
          <div className='btnsWorks'>
            <a href='https://matias5804.github.io/Vidya/' target="_blank" rel='noreferrer'><button>Visit the Site</button></a> 
            <a href='https://github.com/matias5804/Vidya.git' target="_blank" rel='noreferrer'><button>See GitHub</button></a> 
          </div>
        </div>
